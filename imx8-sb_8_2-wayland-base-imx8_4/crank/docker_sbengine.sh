...
runtime=/usr/crank/runtimes/linux-aarch64-opengles_2.0-wayland-obj

sb_binary=$runtime/bin/sbengine
sb_app=Vitals2025/HealthVitalsDemo.gapp
demo_app=$crank_dir/apps/$sb_app



sb_options='-v -orender_mgr,fullscreen -omtdev,device=/dev/input/event2'
echo "-v -orender_mgr,fullscreen -omtdev,device=/dev/input/event2"
